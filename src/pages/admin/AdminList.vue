              ...
              >
                ...
                <v-card-actions>
                  <v-col class="text-right">
                    <v-btn tile color="cyan lighten-3 mx-2" @click="moveModify(post.id)">
                      <v-icon left>
                        mdi-pencil
                      </v-icon>
                        修正
                    </v-btn>
                    <v-btn tile color="red darken-3 mx-2" @click="submitDelete(post.id)">
                      <v-icon left>
                        mdi-delete
                      </v-icon>
                        削除
...
export default {
  ...
  methods: {
    ...
    moveModify(postId){
      this.$router.push({name: 'admin-post-edit', params: { postId }});
    },
    submitDelete(postId){
